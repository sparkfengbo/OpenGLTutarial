...
int main() {
    ...
    Shader ourShader("../shaders/4_1_depth.vs", "../shaders/4_1_depth.fs");
    Shader stencilShader("../shaders/4_1_depth.vs", "../shaders/4_2_stencil.fs");
    ...
    while (!glfwWindowShouldClose(window)){
        ...
        glm::mat4 projection = glm::perspective(glm::radians(camera.Zoom), (float)WINDOW_WIDTH / (float)WINDOW_HEIGHT, 0.3f, 100.0f);
